...
_Learn about the best practices when submitting an app to the app stores._
...
[Versioning your app](https://docs.expo.dev/build-reference/app-versions/)

[App Store presence](https://docs.expo.dev/eas/metadata/)

[Permissions](https://docs.expo.dev/guides/permissions)

[App icons](https://docs.expo.dev/develop/user-interface/splash-screen-and-app-icon/)

[Splash screen](https://docs.expo.dev/develop/user-interface/splash-screen-and-app-icon/)

[App store assets](https://docs.expo.dev/guides/store-assets/)

[Localizing your app](https://docs.expo.dev/guides/localization/)

[Apple: Review guidelines](https://developer.apple.com/distribute/app-review/)
